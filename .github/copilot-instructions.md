...
| 2026-02-28 | implementation | .clang-tidy IMPLEMENTED                 | `.clang-tidy` created with bugprone-use-after-move, bugprone-suspicious-memset as WarningsAsErrors; modernize-* + performance-* as warnings; HeaderFilterRegex targets only src/libslic3r + src/slic3r         | Tier 1 (errors) vs Tier 2 (warnings) split prevents noisy CI while catching real bugs                       |
