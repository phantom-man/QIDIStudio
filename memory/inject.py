...
def _compaction_warning() -> str:
    ...
    return (
        "\n"
        "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n"
        "  CONTEXT COMPACTION OCCURRED — SESSION SUMMARY PENDING     \n"
        "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n"
        f"  Compaction flagged at: {ts}\n"
        "  The conversation summary above contains the full prior session.\n"
        "  In your NEXT response, include a COMPACTION_SUMMARY block:\n"
        "    COMPACTION_SUMMARY: yes\n"
        "    Key decisions: ...\n"
        "    Key gotchas: ...\n"
        "    Files modified: ...\n"
        "  The Stop hook will save this to the knowledge database automatically.\n"
        "  DO NOT write to copilot-instructions.md — learnings live in Postgres now.\n"
        "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n"
    )
