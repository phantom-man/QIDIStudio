...
// view_matrix for world-space light transform.
...
void main()
{
    ...
    // GPU normal matrix using fixed-function modelview (GLSL 1.10 — manual helpers).
    mat3 gpu_nm = mat3_transpose(mat3_inverse(mat3(gl_ModelViewMatrix)));
