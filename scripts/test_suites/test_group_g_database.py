...
def test_g6_quality_metrics_jsonl() -> tuple[bool, str]:
    ...
    if not QUALITY_JSONL.exists():
        ...
        return True, "quality_metrics.jsonl not yet created (autonomous pipeline not yet run)"
...
TESTS: list[tuple[str, str, callable]] = [
    ("G.lancedb_row_count",   "LanceDB knowledge table \u2265 100 rows",        test_g1_lancedb_row_count),
