...
namespace Slic3r
{
    namespace GUI
    {
        ...
        GLGizmoMove3D::GLGizmoMove3D(GLCanvas3D &parent, unsigned int sprite_id, GizmoObjectManipulation *obj_manipulation)
            : GLGizmoBase(parent, sprite_id), m_displacement(Vec3d::Zero()), m_snap_step(1.0), m_starting_drag_position(Vec3d::Zero()), m_starting_box_center(Vec3d::Zero()), m_starting_box_bottom_center(Vec3d::Zero())
              // QDS: GUI refactor: add obj manipulation
              ,
