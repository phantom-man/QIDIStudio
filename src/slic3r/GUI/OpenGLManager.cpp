...
namespace Slic3r
{
    namespace GUI
    {
        ...
        FrameBuffer::FrameBuffer(const FrameBufferParams &params)
            : m_width(params.m_width), m_height(params.m_height), m_msaa(params.m_msaa)
        {
        }
        ...
        {
            const bool rt = m_width == params.m_width && m_height == params.m_height && m_msaa == params.m_msaa;
            return rt;
        }
        ...
        OpenGLManager::FrameBufferModifier::FrameBufferModifier(OpenGLManager &ogl_manager, const std::string &frame_buffer_name, EMSAAType msaa_type)
            : m_ogl_manager(ogl_manager), m_frame_buffer_name(frame_buffer_name), m_msaa_type(msaa_type)
        {
        }
