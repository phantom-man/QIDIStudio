...
namespace Slic3r
{
    ...
    private:
        friend class cereal::access;
        template <class Archive>
        void serialize(Archive &ar) { ar(cereal::base_class<ConfigOptionSingle<double>>(this)); }
    };
    ...
    private:
        friend class cereal::access;
        template <class Archive>
        void serialize(Archive &ar) { ar(cereal::base_class<ConfigOptionSingle<int>>(this)); }
    };
    ...
    public:
        ...
        {
            return std::lexicographical_compare(this->values.begin(), this->values.end(), rhs.values.begin(), rhs.values.end(), [](const auto &l, const auto &r)
                                                { return l < r; });
        }
        bool is_nil(size_t) const override { return false; }
    ...
    private:
        friend class cereal::access;
        template <class Archive>
        void serialize(Archive &ar) { ar(cereal::base_class<ConfigOptionVector>(this)); }
    };
        ...
        ConfigOption *save_option_to_archive(Archive &archive, const ConfigOption *opt) const
        {
            ...
            else
            {
                ...
                case coEnums:
                    ...
                    break;
                case coIntsGroups:
                    archive(*static_cast<const ConfigOptionIntsGroups *>(opt));
                    break;
                default:
    ...
    public:
        ...
        std::ostream &print_cli_help(
            ...
            std::function<bool(const ConfigOptionDef &)> filter = [](const ConfigOptionDef &)
            { return true; }) const;
