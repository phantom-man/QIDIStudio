...
namespace Slic3r
{
    ...
    struct EmbossProjection
    {
        ...
        void serialize(Archive &ar) { ar(depth, use_surface, embeded_depth); }
    };
...
{
    template <class Archive>
    void serialize(Archive &ar, Slic3r::ExPolygonsWithId &o) { ar(o.id, o.expoly, o.is_healed); }
    template <class Archive>
    void serialize(Archive &ar, Slic3r::HealedExPolygons &o) { ar(o.expolygons, o.is_healed); }
}; // namespace cereal
