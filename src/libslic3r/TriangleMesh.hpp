...
namespace Slic3r
{
    ...
    {
        return vertex_idx == triangle_indices[0] ? 0 : vertex_idx == triangle_indices[1] ? 1
    ...
    {
        return triangle_edge(0) == triangle_indices[0] && triangle_edge(1) == triangle_indices[1] ? 0 : triangle_edge(0) == triangle_indices[1] && triangle_edge(1) == triangle_indices[2] ? 1
